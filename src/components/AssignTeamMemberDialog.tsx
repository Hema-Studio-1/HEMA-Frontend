...
export function AssignTeamMemberDialog({
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-background rounded-sm w-full max-w-md p-8 relative"
        ...
        >
          {/* Title */}
          <h2
            className="text-[24px] mb-6 text-foreground"
            style={{
          ...
          <div className="mb-4 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-[#FDFCFB] text-[13px] text-foreground placeholder-[#c5c5c5] focus:outline-none focus:ring-1 focus:ring-foreground/10 transition-all duration-300"
              style={{
          ...
          <div className="mb-6 max-h-64 overflow-y-auto">
            {filteredMembers.length > 0 ? (
              <div className="space-y-1">
                {filteredMembers.map((member) => (
                  ...
                  >
                    {/* Avatar */}
                    <div
                      className="w-8 h-8 rounded-full bg-foreground text-background flex items-center justify-center text-[11px] flex-shrink-0"
                      style={{
                        fontFamily: "'Inter', sans-serif",
                        fontWeight: 500,
                      }}
              ...
              <div
                className="text-center py-8 text-textSecondary text-[13px]"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 300,
                }}
          ...
          <div className="mb-8">
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 bg-[#FDFCFB] text-[13px] text-foreground placeholder-[#c5c5c5] focus:outline-none focus:ring-1 focus:ring-foreground/10 transition-all duration-300 resize-none"
              style={{
                fontFamily: "'Inter', sans-serif",
                fontWeight: 300,
              }}
          ...
          <div className="flex justify-end gap-3">
            <button
              onClick={handleClose}
              className="px-6 py-2.5 text-[13px] text-[#626262] hover:text-foreground transition-colors duration-300"
              style={{
                fontFamily: "'Inter', sans-serif",
                fontWeight: 300,
              }}
            ...
            <button
              ...
              className={`px-6 py-2.5 text-[13px] rounded-sm transition-all duration-300 ${
                selectedMemberId
                  ? "bg-foreground text-background hover:bg-[#3d3d3d]"
