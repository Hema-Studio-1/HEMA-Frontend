        ...
        <SheetBody>
          <div className="space-y-8">
            ...
            {spaceData.styleTags && spaceData.styleTags.length > 0 && (
              <div>
                <label
                  className="block text-[11px] text-textSecondary mb-3 uppercase tracking-wider"
                  style={{
                    fontFamily: "'Inter', sans-serif",
                    fontWeight: 400,
                    letterSpacing: "0.08em",
            ...
            {/* Generated Assets */}
            {spaceData.generatedAssets &&
              spaceData.generatedAssets.length > 0 && (
                <div>
                  <label
                    className="block text-[11px] text-textSecondary mb-3 uppercase tracking-wider"
                    style={{
                  ...
                  <ul className="space-y-2">
                    {spaceData.generatedAssets.map((asset, index) => (
                      ...
                      >
                        <span className="text-textSecondary mt-1">•</span>
                        <span>{asset}</span>
                      </li>
                    ))}
                  </ul>
