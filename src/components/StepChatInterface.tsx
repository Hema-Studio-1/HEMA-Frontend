      ...
      <div className="border-t border-[#E8E6E3]/50 pt-6">
        <div className="flex items-end gap-3">
          <input
            ...
            className="flex-1 px-0 py-2 text-[13px] text-foreground placeholder:text-[#c5c5c5] focus:outline-none bg-transparent border-b border-[#E8E6E3] focus:border-[#A4AC96] transition-colors duration-500"
            style={{
              fontFamily: "'Inter', sans-serif",
              fontWeight: 300,
            }}
          ...
          <button
            ...
            className="p-2 text-textSecondary hover:text-[#626262] transition-colors duration-300 disabled:opacity-30 disabled:cursor-not-allowed"
          >
