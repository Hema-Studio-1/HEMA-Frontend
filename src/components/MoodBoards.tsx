...
export function MoodBoards() {
  ...
  const [selectedMoodBoardForInfo, setSelectedMoodBoardForInfo] = useState<
    string | null
  >(null);
  const [selectedMoodBoardForView, setSelectedMoodBoardForView] = useState<
    string | null
  >(null);
  const [deleteDialogOpen, setDeleteDialogOpen] = useState(false);
  const [moodBoardToDelete, setMoodBoardToDelete] = useState<string | null>(
    null,
  );
            ...
            {moodBoards.length === 0 ? (
              <div className="flex-1 flex items-center justify-center px-4">
                ...
                >
                  ...
                  <h3
                    className="text-[28px] mb-4 text-foreground"
                    style={{
                  ...
                  <p
                    className="text-[13px] text-textSecondary mb-10 max-w-sm"
                    style={{
                  ...
                  >
                    Create your first mood board to collect and organize
                    inspiration
                  </p>

                  <button
                    onClick={() => setIsCreateDrawerOpen(true)}
                    className="px-6 py-3 bg-foreground text-[#FDFCFB] text-[13px] rounded-sm hover:opacity-80 transition-opacity duration-300"
                    style={{
                      fontFamily: "'Inter', sans-serif",
                      fontWeight: 300,
              ...
              <div className="flex-1 flex items-center justify-center px-4">
                ...
                >
                  ...
                  <h3 className="text-[22px] mb-2 text-foreground">
                    No mood boards match your search
                  </h3>

                  <p className="text-[13px] text-textSecondary mb-6 leading-relaxed w-[80%]">
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-foreground text-[#FDFCFB] text-[13px] rounded-sm hover:opacity-80 transition-opacity duration-300"
                    style={{
                      fontFamily: "'Inter', sans-serif",
                      fontWeight: 300,
                      letterSpacing: "0.05em",
                ...
                {filteredMoodBoards.map((moodBoard) => (
                  ...
                  >
                    ...
                    <div className="mt-3">
                      ...
                      >
                        {moodBoard.type} • {moodBoard.images.length}{" "}
                        {moodBoard.images.length === 1 ? "item" : "items"}
                      </p>
                    </div>
                    ...
                    {hoveredId === moodBoard.id && (
                      ...
                      >
                        <button
                          ...
                          className="p-1.5 hover:bg-background rounded-sm transition-colors duration-300"
          ...
          <div className="flex flex-col min-h-0 pl-6">
            ...
            <div className="mb-10">
              <input
                ...
                className="w-full px-0 py-2 text-[13px] bg-transparent border-b border-[#E8E6E3] text-foreground placeholder-[#c5c5c5] focus:outline-none focus:border-foreground transition-colors duration-300"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 300,
                }}
            ...
            {/* Filter by Type */}
            <div className="mb-10">
              <p className="text-xs text-textSecondary mb-3">Filter by type</p>
            ...
            {(searchQuery || selectedType || showLikedOnly) && (
              <button
                className="text-[11px] text-textSecondary hover:text-foreground transition-colors duration-300"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 300,
                  letterSpacing: "0.05em",
        ...
        moodBoard={
          selectedMoodBoardInfoData
            ? {
                ...
                createdDate:
                  selectedMoodBoardInfoData.createdAt.toLocaleDateString(
                    "en-US",
