...
const assets: Asset[] = [
  ...
  },
  {
    ...
    category: "Storage",
    imageUrl:
      "https://images.unsplash.com/photo-1595428773637-056682d2c8e7?w=800&q=80",
  },
  {
    id: "12",
    name: "Table Lamp",
...
export function AssetSelector({
  ...
  return (
    ...
    >
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-foreground/10 backdrop-blur-sm transition-opacity duration-500"
        onClick={onClose}
      />
            ...
            {assets.map((asset) => {
              ...
              return (
                ...
                >
                  <div
                    className={`overflow-hidden rounded-sm transition-all duration-300 ${
                      isSelected
                        ...
                        : "ring-1 ring-transparent hover:ring-[#E8E6E3]"
                    }`}
                  >
                    <img
                      src={asset.imageUrl}
                  ...
                  {/* Selection indicator */}
                  {isSelected && (
                    <div className="absolute top-2 right-2 w-6 h-6 bg-foreground rounded-sm flex items-center justify-center">
                      <Check
                        size={14}
                        className="text-[#FDFCFB]"
                        strokeWidth={2}
                      />
                    </div>
                  )}
