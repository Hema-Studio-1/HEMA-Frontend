...
export function Filters() {
  ...
  const FilterSection = ({ 
    ...
    <div className="mb-10">
      <p 
        className="text-sm uppercase tracking-widest text-[#9a9a9a] mb-4"
      >
        {title}
      </p>
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-28 right-8 z-[100] flex items-center gap-2 text-[12px] text-[#9a9a9a] hover:text-[#626262] transition-colors duration-300"
        style={{ 
      ...
      {isExpanded && (
        <div 
          className="fixed inset-0 bg-[#2a2a2a]/5 backdrop-blur-sm z-[90] transition-opacity duration-500"
