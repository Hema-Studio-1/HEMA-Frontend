...
export function CreateMoodBoardDrawer({ onClose, onCreate }: CreateMoodBoardDrawerProps) {
      ...
      <Sheet open onOpenChange={(open) => { if (!open) onClose(); }}>
        <SheetContent side="right" className='max-w-2xl'>
          ...
          <div className="mb-12">
            ...
            <div className="mb-6">
              <label 
                className="block text-[11px] uppercase tracking-widest text-[#9a9a9a] mb-3"
                style={{ 
          ...
          <div className={images.length === 0 ? "mb-0" :'mb-8'}>
            ...
            {/* Canvas - Fixed Size */}
            <div 
              className="bg-[#F7F5F2] rounded-sm mb-6 overflow-hidden"
              style={{ height: '400px' }}
            >
              {images.length === 0 ? (
                <div
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 text-[13px] border rounded-sm transition-all duration-300 ${
                  images.length >= 10
                    ...
                    : 'border-[#E8E6E3] text-[#626262] hover:border-[#2a2a2a] hover:text-[#2a2a2a]'
                }`}
                style={{ 
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 300,
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-5 gap-3">
                {images.map((img, idx) => (
                  <div 
                    key={idx}
                    className="relative bg-[#F7F5F2] rounded-sm overflow-hidden group"
                  ...
                  >
                    ...
                    >
                      <X size={10} className="text-[#626262]" strokeWidth={1.5} />
                    </button>
                  </div>
                ))}
              </div>
