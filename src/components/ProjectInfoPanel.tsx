import { ChevronRight, Edit2, UserPlus, X } from "lucide-react";
...
export function ProjectInfoPanel({
  ...
  const statusColors = {
    ...
    Final: "bg-[#8a9280]/10 text-foreground border border-[#8a9280]/30",
  };
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed inset-0 bg-foreground/10 z-40 transition-opacity duration-300"
          onClick={onClose}
        />
      )}
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-[460px] bg-background z-50 transition-transform duration-300 ease-out flex flex-col ${
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-8 py-8">
          <div className="space-y-8">
            ...
            <div>
              <label
                className="block text-[11px] text-textSecondary mb-2 uppercase tracking-wider"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 400,
              ...
              <p
                className="text-[14px] text-foreground mb-4"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 300,
                  lineHeight: "1.7",
              ...
              <div className="flex items-center gap-4">
                <div>
                  ...
                  >
                    {project.spacesCount}{" "}
                    {project.spacesCount === 1 ? "Space" : "Spaces"}
                  </span>
                </div>
            ...
            <div>
              <label
                className="block text-[11px] text-textSecondary mb-4 uppercase tracking-wider"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  fontWeight: 400,
                  letterSpacing: "0.08em",
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <label
                  className="block text-[11px] text-textSecondary uppercase tracking-wider"
                  style={{
                    fontFamily: "'Inter', sans-serif",
                    fontWeight: 400,
                    letterSpacing: "0.08em",
                ...
                <button
                  onClick={onAssignMember}
                  className="text-[11px] text-[#626262] hover:text-foreground transition-colors duration-300"
                  style={{
                    fontFamily: "'Inter', sans-serif",
                    fontWeight: 300,
                    ...
                    <div className="flex-1">
                      ...
                      >
                        ...
                        {member.assignedSpaces && member.assignedSpaces > 0 && (
                          <>
                            {" "}
                            · {member.assignedSpaces}{" "}
                            {member.assignedSpaces === 1 ? "space" : "spaces"}
                          </>
                        )}
                      </p>
                    </div>
