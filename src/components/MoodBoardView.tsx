...
export function MoodBoardView({
  ...
  const [selectedInteriorRender, setSelectedInteriorRender] =
        ...
        <div className="w-[65%] bg-background p-12 flex items-center justify-center relative">
          <div
            ...
            style={{
              display: "grid",
              gridTemplateColumns:
                moodBoard.images.length === 1 ? "1fr" : "repeat(2, 1fr)",
              gap: "16px",
              maxHeight: "100%",
            }}
          >
            {moodBoard.images.map((img, idx) => (
              <div
                ...
                style={{
                  gridColumn:
                    moodBoard.images.length === 1 ? "span 2" : undefined,
                }}
              >
                <img
                  src={img}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex border border-[#E8E6E3] rounded-sm overflow-hidden">
                    <button
                      onClick={() =>
                        setSelectedInteriorRender("Precise render")
                      }
                    ...
                    <button
                      onClick={() =>
                        setSelectedInteriorRender("Creative render")
                      }
            ...
            <div>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full px-4 py-2.5 bg-[#FDFCFB] border border-[#E8E6E3] rounded-sm text-left hover:border-[#c5c5c5] hover:bg-background transition-colors duration-300"
                >
                  <span
                    className="text-[13px] text-foreground"
                    style={{
